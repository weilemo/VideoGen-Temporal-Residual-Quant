...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_path", type=str, default=str(DEFAULT_MODEL_CONFIG_PATH), help="Path to the config file")
    parser.add_argument("--checkpoint_path", type=str, default=str(DEFAULT_ROLLING_FORCING_CKPT), help="Path to the checkpoint folder")

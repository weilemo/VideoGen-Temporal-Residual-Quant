...
high_precision_quant_type="${HIGH_PRECISION_QUANT_TYPE:-triton-nstages-kmeans-int4}"
low_precision_quant_type="${LOW_PRECISION_QUANT_TYPE:-triton-nstages-kmeans-int2}"
...
echo "Running Self-Forcing random head-wise quant inference"

...
class CausalInferencePipeline(torch.nn.Module):
    def __init__(
        ...
        self.generator = WanDiffusionWrapper(
            **getattr(args, "model_kwargs", {}), 
            local_attn_size=getattr(args, "method", {}).get("local_attn_size"),
            sink_size=getattr(args, "method", {}).get("sink_size"),
            ...
            for index, current_timestep in enumerate(self.denoising_step_list):
                ...
                if index < len(self.denoising_step_list) - 1:
                    _, denoised_pred = self.generator(
                        ...
                        chunk_index=current_start_frame // self.num_frame_per_block,
                        step_index=index,
                        part=part,
                    )
    ...
    def _initialize_kv_cache(self, batch_size, dtype, device, meta):
        ...
        if hasattr(self, "kv_cache1") and self.kv_cache1 is not None:
            del self.kv_cache1
            self.kv_cache1 = None

...
from wan.modules.focusedforcing.focusedforcing import causal_rope_apply_triton, rope_apply_temporal_shift
...
class CausalWanAttentionBlock(nn.Module):
    ...
    def forward(
        ...
        y = self.self_attn(
            ...
            seq_lens, grid_sizes,
            freqs, block_mask, kv_cache, current_start, cache_start, video_index, chunk_index, step_index, block_index)

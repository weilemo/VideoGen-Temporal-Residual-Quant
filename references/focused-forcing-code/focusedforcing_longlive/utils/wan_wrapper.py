        ...
        if is_causal:
            if use_infinite_attention:
                self.model = CausalWanModelInfinity.from_pretrained(
                    "/path/to/.cache/huggingface/hub/models--Wan-AI--Wan2.1-T2V-1.3B/snapshots/37ec512624d61f7aa208f7ea8140a131f93afc9a", local_attn_size=local_attn_size, sink_size=sink_size)
            else:

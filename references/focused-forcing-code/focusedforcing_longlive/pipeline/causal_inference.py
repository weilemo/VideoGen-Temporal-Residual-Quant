...
class CausalInferencePipeline(torch.nn.Module):
    ...
    def inference(
        ...
        local_attn_cfg = self.local_attn_size
        kv_policy = ""
        if local_attn_cfg != -1:
            # local attention
            ...
            kv_policy = "global (-1)"
        print(f"local_attn_size: {local_attn_cfg}, kv_cache_size: {kv_cache_size} (policy: {kv_policy}, frame_seq_length: {self.frame_seq_length}, num_output_frames: {num_output_frames})")

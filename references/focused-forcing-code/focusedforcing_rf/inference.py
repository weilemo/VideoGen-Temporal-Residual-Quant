...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_path", type=str, default="/path/to/.cache/huggingface/hub/models--TencentARC--RollingForcing/snapshots/20edee70781b8586d03f9a9a42b613f8fa8f556a/checkpoints/rolling_forcing_dmd.pt", help="Path to the checkpoint folder")

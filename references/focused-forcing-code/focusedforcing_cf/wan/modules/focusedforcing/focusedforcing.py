    ...
    if local_start_index == 0:
        ...
        if updating_cache: # updating working cache with clean frame
            ...
            if start_chunk_index >= 6:
                ...
                # print("rope_query.shape:", roped_query.shape, "working_cache_key.shape:", working_cache_key.shape, "working_cache_v.shape:", working_cache_v.shape)
            ...
            if start_chunk_index >= 3:
                ...
                # print("rope_query.shape:", roped_query.shape, "input_key.shape:", input_key.shape, "input_v.shape:", input_v.shape)
